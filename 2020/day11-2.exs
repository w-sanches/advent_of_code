defmodule Day_11_2 do
  ...
  defp seat_in_direction({x, y}, vertical_movement, horizontal_movement, seat_map) do
    ...
    seat = Map.get(seat_map, new_place)
...
IO.inspect(Day_11_2.answer())

ExUnit.start()

defmodule Day_11_2Test do
  ...
  test "process/1" do
    ...
    assert input |> Day_11_2.transform() |> Day_11_2.process() == 26
  end
end
